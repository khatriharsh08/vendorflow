...
export function Card({ title, action = null, actions = null, children, className = '', noPadding = false }) {
    return (
...
export function ListCard({ title, actions = null, items = [], emptyIcon = '✅', emptyMessage = 'Nothing here' }) {
    return (
