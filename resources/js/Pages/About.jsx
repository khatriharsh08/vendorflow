                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-start">
                            ...
                            <div className="lg:sticky lg:top-24 space-y-8">
                                ...
                                <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                    <p>
                                        VendorFlow was born out of frustration. After years of
                                        managing vendors using spreadsheets, emails, and
                                        disconnected tools, we knew there had to be a better way.
                                    </p>
                                    <p>
                                        We built the platform we wished we had — one that brings
                                        everything together in a single, intuitive interface. Today,
                                        we help businesses streamline operations, from onboarding to
                                        payments.
                                    </p>
                                    <p>
                                        Our goal is simple: to give you back the time you spend on
                                ...
                                {[
                                    {
                                        ...
                                        desc: "Powerful features shouldn't mean complex interfaces. We design for clarity.",
                                        icon: '✨',
                                    },
                                    {
                                        title: 'Security Always',
                                        desc: 'Your vendor data is sensitive. We treat it with enterprise-grade protection.',
                                        icon: '🛡️',
                                    },
                                    {
                                        title: 'Automation Matters',
                                        desc: 'Manual work leads to errors. Smart automation leads to peace of mind.',
                                        icon: '⚙️',
                                    },
                                    {
                                        title: 'Support Counts',
                                        desc: "Great software is backed by great people. We're here when you need us.",
                                        icon: '🤝',
                                    },
                                ].map((value, idx) => (
                                    <div
                    ...
                    <div className="max-w-4xl mx-auto px-6 text-center">
                        <div className="inline-block p-6 rounded-2xl bg-white shadow-xl border border-gray-100 transform hover:-translate-y-1 transition-transform duration-300">
                            ...
                            <h2 className="text-2xl font-bold text-gray-900 mb-4">
                                Built proudly in India
                            </h2>
                            <p className="text-gray-600 max-w-lg mx-auto">
                                Designed specifically for the needs of Indian businesses. We
                                understand GST compliance, local banking, and the unique challenges
                                you face.
                            </p>
                        </div>
