        ...
        <div className="min-h-screen bg-[var(--gradient-page)] flex items-center justify-center p-6">
            <div className="max-w-md w-full text-center">
                ...
                <div className="mb-6 flex justify-center">
                    <div className="w-24 h-24 rounded-full bg-[var(--color-danger)]/10 flex items-center justify-center text-[var(--color-danger)]">
                        {icon}
                    </div>
                </div>
                ...
                {/* Status Code */}
                <div className="mb-4">
                    <span className="text-7xl font-bold bg-gradient-to-r from-[var(--color-brand-primary)] to-[var(--color-brand-secondary)] bg-clip-text text-transparent">
                        {statusCode}
                    </span>
                </div>
                ...
                <p className="text-[var(--color-text-tertiary)] mb-8">{description}</p>
                ...
                {/* Home Link */}
                <div className="mt-6">
                    <Link href="/" className="text-sm text-[var(--color-brand-primary)] hover:underline">
