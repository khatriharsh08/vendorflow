                ...
                <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-(--color-bg-primary) border border-(--color-border-primary) rounded-xl p-6 shadow-(--shadow-sm)">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-(--color-text-tertiary)">Pending Amount</span>
                    ...
                    <div className="bg-(--color-bg-primary) border border-(--color-border-primary) rounded-xl p-6 shadow-(--shadow-sm)">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-(--color-text-tertiary)">Total Paid</span>
                            <span className="text-2xl">✅</span>
                        </div>
                    ...
                    <div className="bg-(--color-bg-primary) border border-(--color-border-primary) rounded-xl p-6 shadow-(--shadow-sm)">
                        <div className="flex items-center justify-between mb-2">
                            <span className="text-(--color-text-tertiary)">Total Requests</span>
                            <span className="text-2xl">📋</span>
                        </div>
                            ...
                            <table className="w-full">
                                ...
                                <tbody>
                                    {displayPayments.map((payment) => (
                                        <tr
                                            key={payment.id}
                                            className="border-b border-(--color-border-secondary) hover:bg-(--color-bg-hover) transition-colors"
                                        >
                                            <td className="p-4">
                                            ...
                                            <td className="p-4">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-medium ${statusColors[payment.status] || 'bg-gray-100 text-gray-500'}`}
                                                >
